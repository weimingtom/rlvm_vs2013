...
struct Codepage {
  ...
  virtual void JisDecodeString(const unsigned char* s, unsigned char* buf, size_t buflen) const;
  virtual void JisEncodeString(const unsigned char* s, unsigned char* buf, size_t buflen) const;
  virtual unsigned short Convert(unsigned short ch) const = 0;
  virtual std::wstring ConvertString(const std::string& s) const = 0;
  virtual bool DbcsDelim(unsigned char* str) const;
