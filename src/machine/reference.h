...
template <typename ACCESS>
MemoryReferenceIterator<ACCESS>::MemoryReferenceIterator(): store_register_(NULL), memory_(NULL), type_(-1), location_(0) {}
...
MemoryReferenceIterator<ACCESS>::MemoryReferenceIterator(Memory* memory,
    ...
    : memory_(memory),
      type_(in_type),
      location_(in_location), store_register_(NULL) {}
