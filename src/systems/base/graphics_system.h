...
class GraphicsSystem : public EventListener {
 public:
  ...
  virtual std::shared_ptr<Surface> EndFrameToSurface()/* = 0*/ {return 0;}//;
  ...
  virtual std::shared_ptr<Surface> GetHaikei()/* = 0*/ {return 0;}//;

  virtual std::shared_ptr<Surface> GetDC(int dc)/* = 0*/{return 0;}//;

  virtual std::shared_ptr<Surface> BuildSurface(const Size& size)/* = 0*/{return 0;}//;

  virtual ColourFilter* BuildColourFiller()/* = 0*/{return 0;}//;
 ...
 private:
  ...
  virtual std::shared_ptr<const Surface> LoadSurfaceFromFile(
      const std::string& short_filename)/* = 0*/{return 0;}//;
