...
void addUnifiedFunctions(ObjectModule& h) {
  h.AddDoubleObjectCommands(0, "Move",
                            GraphicsObject::func_x,
                            GraphicsObject::func_SetX,
							GraphicsObject::func_y,
							GraphicsObject::func_SetY);
  ...
  h.AddSingleObjectCommands(3, "Alpha",
                            GraphicsObject::func_raw_alpha,
                            GraphicsObject::func_SetAlpha);

  // ----

  h.AddCustomRepno<adjust, objEveAdjust>(6, "Adjust");
  h.AddRepnoObjectCommands(7, "AdjustX",
                           GraphicsObject::func_x_adjustment,
                           GraphicsObject::func_SetXAdjustment);
  h.AddRepnoObjectCommands(8, "AdjustY",
						   GraphicsObject::func_y_adjustment,
						   GraphicsObject::func_SetYAdjustment);
  h.AddSingleObjectCommands(9, "Mono",
	                       GraphicsObject::func_mono,
						   GraphicsObject::func_SetMono);
  h.AddSingleObjectCommands(10, "Invert",
	  GraphicsObject::func_invert,
						   GraphicsObject::func_SetInvert);
  h.AddSingleObjectCommands(11, "Light",
                           GraphicsObject::func_light,
						   GraphicsObject::func_SetLight);

  // ---

  h.AddSingleObjectCommands(13, "TintR",
                            GraphicsObject::func_tint_red,
							GraphicsObject::func_SetTintRed);
  h.AddSingleObjectCommands(14, "TintG",
                            GraphicsObject::func_tint_green,
							GraphicsObject::func_SetTintGreen);
  h.AddSingleObjectCommands(15, "TintB",
                            GraphicsObject::func_tint_blue,
							GraphicsObject::func_SetTintBlue);

  // ---

  h.AddSingleObjectCommands(17, "ColR",
                            GraphicsObject::func_colour_red,
							GraphicsObject::func_SetColourRed);
  h.AddSingleObjectCommands(18, "ColG",
                            GraphicsObject::func_colour_green,
							GraphicsObject::func_SetColourGreen);
  h.AddSingleObjectCommands(19, "ColB",
                            GraphicsObject::func_colour_blue,
							GraphicsObject::func_SetColourBlue);
  h.AddSingleObjectCommands(20, "ColLevel",
                            GraphicsObject::func_colour_level,
							GraphicsObject::func_SetColourLevel);

  h.AddSingleObjectCommands(36, "AdjustVert",
							GraphicsObject::func_vert,
							GraphicsObject::func_SetVert);

  h.AddRepnoObjectCommands(40, "AdjustAlpha",
							GraphicsObject::func_alpha_adjustment,
							GraphicsObject::func_SetAlphaAdjustment);

  // --
  h.AddDoubleObjectCommands(46, "Scale",
							GraphicsObject::func_width,
							GraphicsObject::func_SetWidth,
							GraphicsObject::func_height,
							GraphicsObject::func_SetHeight);
  ...
  h.AddSingleObjectCommands(49, "Rotate",
							GraphicsObject::func_rotation,
							GraphicsObject::func_SetRotation);
  h.AddDoubleObjectCommands(50, "RepOrigin",
							GraphicsObject::func_rep_origin_x,
							GraphicsObject::func_SetRepOriginX,
							GraphicsObject::func_rep_origin_y,
							GraphicsObject::func_SetRepOriginY);
  ...
  h.AddDoubleObjectCommands(53, "Origin",
							GraphicsObject::func_origin_x,
							GraphicsObject::func_SetOriginX,
							GraphicsObject::func_origin_y,
							GraphicsObject::func_SetOriginY);
  ...
  h.AddDoubleObjectCommands(61, "HqScale",
                            GraphicsObject::func_hq_width,
							GraphicsObject::func_SetHqWidth,
							GraphicsObject::func_hq_height,
							GraphicsObject::func_SetHqHeight);
...
void addObjectFunctions(RLModule& m) {
  m.AddOpcode(
      1004, 0, "objShow", new Obj_SetOneIntOnObj(GraphicsObject::func_SetVisible));
  ...
  m.AddOpcode(1021,
              0,
              "objComposite",
              new Obj_SetOneIntOnObj(GraphicsObject::func_SetCompositeMode));
  ...
  m.AddOpcode(
      1026, 0, "objLayer", new Obj_SetOneIntOnObj(GraphicsObject::func_SetZLayer));
  m.AddOpcode(
      1027, 0, "objDepth", new Obj_SetOneIntOnObj(GraphicsObject::func_SetZDepth));
  m.AddUnsupportedOpcode(1028, 0, "objScrollRate");
  m.AddOpcode(1029,
              0,
              "objScrollRateX",
              new Obj_SetOneIntOnObj(GraphicsObject::func_SetScrollRateX));
  m.AddOpcode(1030,
              0,
              "objScrollRateY",
              new Obj_SetOneIntOnObj(GraphicsObject::func_SetScrollRateY));
  m.AddOpcode(1031, 0, "objDriftOpts", new objDriftOpts);
  m.AddOpcode(
      1032, 0, "objOrder", new Obj_SetOneIntOnObj(GraphicsObject::func_SetZOrder));
  ...
  m.AddOpcode(1037,
              0,
              "objSetDigits",
              new Obj_SetOneIntOnObj(GraphicsObject::func_SetDigitValue));
  m.AddOpcode(1038, 0, "objNumOpts", new objNumOpts);
  m.AddOpcode(
      1039, 0, "objPattNo", new Obj_SetOneIntOnObj(GraphicsObject::func_SetPattNo));
  ...
  m.AddOpcode(1066,
              0,
              "objBtnState",
              new Obj_SetOneIntOnObj(GraphicsObject::func_SetButtonState));
...
void addEveObjectFunctions(RLModule& m) {
  m.AddOpcode(2004,
              0,
              "objEveDisplay",
              new Obj_SetOneIntOnObj(GraphicsObject::func_SetVisible));
